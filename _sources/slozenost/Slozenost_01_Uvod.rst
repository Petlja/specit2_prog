...
-  Анализа најгорег случаја заснива процену сложености алгоритма на
   ...
   свим случајевима може да се изврши са расположивим ресурсима.
...
Иако се мерење времена извршавања може урадити за сваки програм, често
...
бржа од квадратне (и што је :math:`n` веће, она је све бржа).
...
су нам сабирања једино значајна).
...
функција позива за све вредности :math:`k` од 1 до :math:`n`, то се 
укупно изврши
:math:`1 + 2 + \ldots + n = \frac{n(n+1)}{2} = \frac{1}{2}n^2 + \frac{1}{2}n`
сабирања. И ако бисмо рачунали све инструкције, добили бисмо да је број
...
највише десетак пута (па нека је и стотинак) пута, али не могу да утичу
...
-  :math:`O(\sqrt{n})` - “логаритам за оне са јефтинијим улазницама” -
   немамо најбоља места, али ипак можемо да гледамо утакмицу, нпр.
