...
**база индукције**, а друго **индуктивни корак**. Принцип математичке
...
-  Имплементација алгоритма може бити таква да променљиве унутар петље
   ...
   слично принципу математичке индукције, кажемо да је алгоритам
...
иницијализацији променљиве пре уласка у петљу) и индуктивни корак
...
Дефинисање алгоритама индуктивно-рекурзивном конструкцијом је у веома
...
Пре него што пређемо на формални доказ претходног разматрања, скренимо
...
ћемо претпостављати да бројање креће од нуле (нпр. :math:`а_0`,
:math:`а_1`, …).
