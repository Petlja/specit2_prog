...
Rešenje standardnim bektrekom. Ovo rešenje je dovoljno za varijantu A, koja ima manje drvo pretrage.
 */
using System;
...
namespace Ikosaedar
{
    class Program
    {
        ...
        static int[,] Susedstvo = SusedstvoA; // SusedstvoA ili SusedstvoB
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(" : " + NajnizaCena); // A: 1_963 (B traje vrlo dugo)
            Console.WriteLine(BrPoziva); // A: 742_580 (B traje vrlo dugo)
        }
    }
}
