// Ova verzija se od neoptimizovane razlikuje samo 
// u redosledu nabrajanja poteza u "int[,] Potezi".
// Naravno, redosled nabrajanja je pazljivo smisljen,
// jer on utice i na redosled isprobavanja poteza.
// Razlikujemo 6 tipova polja oznacenih na shemi:
//
//                    F E E F
//                   E D C D E
//                  E C B B C E
...
//                    F E E F
//
// Prvo se isprobavaju potezi tipa ECB, zatim redom
// tipova  FDB,  BBC, ABD, BAB, DCD, CBB, DBA, EDC,
// BCE, CDE, i na kraju tipa BDF. (potez je tipa XYZ
// ako figura sa polja tipa X preskace figuru na 
// polju tipa Y i dolazi na polje tipa Z).
...
namespace PreskakalicaOpt
{
    public partial class Form1 : Form
    {
        ...
        int[,] Potezi = { // int[114, 3] 
            {21, 8, 1}, {24,10, 2}, {27,12, 3}, {30,14, 4}, {33,16, 5}, {36,18, 6}, // ecb
            {35,18, 1}, {20, 8, 2}, {23,10, 3}, {26,12, 4}, {29,14, 5}, {32,16, 6}, // ecb
            {19, 7, 1}, {22, 9, 2}, {25,11, 3}, {28,13, 4}, {31,15, 5}, {34,17, 6}, // fdb
            { 6, 1, 8}, { 1, 2,10}, { 2, 3,12}, { 3, 4,14}, { 4, 5,16}, { 5, 6,18}, // bbc
            { 3, 2, 8}, { 4, 3,10}, { 5, 4,12}, { 6, 5,14}, { 1, 6,16}, { 2, 1,18}, // bbc
            { 0, 1, 7}, { 0, 2, 9}, { 0, 3,11}, { 0, 4,13}, { 0, 5,15}, { 0, 6,17}, // abd
            { 1, 0, 4}, { 2, 0, 5}, { 3, 0, 6}, { 4, 0, 1}, { 5, 0, 2}, { 6, 0, 3}, // bab
            { 7, 8, 9}, { 9,10,11}, {11,12,13}, {13,14,15}, {15,16,17}, {17,18, 7}, // dcd
            { 9, 8, 7}, {11,10, 9}, {13,12,11}, {15,14,13}, {17,16,15}, { 7,18,17}, // dcd
            { 8, 1, 6}, {10, 2, 1}, {12, 3, 2}, {14, 4, 3}, {16, 5, 4}, {18, 6, 5}, // cbb
            {16, 6, 1}, {18, 1, 2}, { 8, 2, 3}, {10, 3, 4}, {12, 4, 5}, {14, 5, 6}, // cbb
            { 7, 1, 0}, { 9, 2, 0}, {11, 3, 0}, {13, 4, 0}, {15, 5, 0}, {17, 6, 0}, // dba
            {20, 7,18}, {23, 9, 8}, {26,11,10}, {29,13,12}, {32,15,14}, {35,17,16}, // edc
            {36, 7, 8}, {21, 9,10}, {24,11,24}, {27,13,14}, {30,15,16}, {33,17,18}, // edc
            { 1, 8,21}, { 2,10,24}, { 3,12,27}, { 4,14,30}, { 5,16,33}, { 6,18,36}, // bce
            { 1,18,35}, { 2, 8,20}, { 3,10,23}, { 4,12,26}, { 5,14,29}, { 6,16,32}, // bce
            {18, 7,20}, { 8, 9,23}, {10,11,26}, {12,13,29}, {14,15,32}, {16,17,35}, // cde
            { 8, 7,36}, {10, 9,21}, {12,11,24}, {14,13,27}, {16,15,30}, {18,17,33}, // cde
            { 1, 7,19}, { 2, 9,22}, { 3,11,25}, { 4,13,28}, { 5,15,31}, { 6,17,34}  // bdf
        };
        int R_POLJA;
        ...
        public Form1()
        {
            ...
            Text = "Preskakalica (optimizovana)";
